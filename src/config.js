...
export const PANEL_URL = 'https://panel-pasaporte593.netlify.app'
export const BVP_URL = 'https://bvpoints.netlify.app'
export const REGISTRO_URL = 'https://panel-pasaporte593.netlify.app'

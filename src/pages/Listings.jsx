      ...
      <section className="bg-brand-navy py-14">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="font-body text-white/70 text-base max-w-xl mx-auto leading-relaxed">
            Encuentra tu próxima parada, visita el local, sella tu pasaporte y acumula puntos BookVipPoints.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 py-4 flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between">
          ...
          <div className="relative w-full sm:w-72">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2.5 font-body text-sm border border-gray-200 rounded-xl focus:outline-none focus:border-brand-orange"
            />
          </div>
          {/* Category pills */}
          <div className="flex gap-2 overflow-x-auto pb-1 sm:pb-0 flex-nowrap">
            {CATEGORIES.map(cat => (
              <button
                ...
                className={`flex-shrink-0 font-body text-sm font-medium px-3 py-1.5 rounded-full transition-colors ${
                  activeCategory === cat
